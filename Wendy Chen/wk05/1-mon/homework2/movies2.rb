...
#Extra credit:
#Consider updating the search functionality so that if you just get one
#movie back - you don't show the list but take the user straight to the page
#that shows the information (fewer clicks makes for better user experience).
